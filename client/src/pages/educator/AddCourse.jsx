        ...
        <div className='flex items-center justify-between flex-wrap'>
          ...
          <div className='flex md:flex-row flex-col items-center gap-3'>
            ...
            <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
              ...
              <input type="file" id='thumbnailInage' onChange={e=> setImage(e.target.files[0])} accept='image/*' hidden />
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture,lectureIndex)=>(
                    ...
                    <span>{lectureIndex + 1 } {lecture.lectureTitle} - {lecture.lectureDuartion} mins - <a href={lecture.lectureUrl} target='_blank' className='text-blue-500'>Link</a> - {lecture.isPreviewFree? 'Free Preview' : 'Paid' }</span>
